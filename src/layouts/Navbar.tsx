  ...
  const NAV_ITEMS: Array<NavItem> = [
    {
      ...
      children: [
        {
          label: 'Explore Our recent articles',
          subLabel: 'Courses to inspire you',
          href: '#',
        },
        {
    ...
    },
    {
      ...
      children: [
        {
          label: 'HTML & CSS',
          subLabel: 'Quick Start & learn the basics of HTML & CSS',
          href: '#',
        },
        {
          label: 'Get into Python',
          subLabel: 'An exclusive course for python',
          href: '#',
        },
      ],
    },
